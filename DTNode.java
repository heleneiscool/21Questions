...
public class DTNode{
    ...
    private String text;
    private Map<String, DTNode> nodes = new HashMap<String, DTNode>();
     ...
     */
    public DTNode(String txt, HashMap<String, DTNode> nodeList){
        text = txt;
        setChildren(nodeList);
    }
    public void addNode(String question, DTNode ans){
    nodes.put(question, ans);
    }

    /** Getters */
    public String getText(){return text;}

    public DTNode getNodeAt(String index){return nodes.get(index);}
    public Map<String, DTNode> getAllNodes(){
...
public void setChildren(HashMap<String, DTNode> nodes){
    this.nodes = nodes;
}
